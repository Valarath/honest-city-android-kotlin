...
class ExchangeRateAnalyticGateway(private val imageExchangeRateProvider: ImageExchangeRateProvider):InternalImageAnalyticGateway {

    override fun analyze(imageData: AnalyzeImageData, textCallback:(lines:List<String>)->Unit): Observable<Unit> =
